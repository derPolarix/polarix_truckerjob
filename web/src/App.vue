...
function mapServerResponse(data: any): Partial<DashboardConfig> {
	...
	const orders: Order[] = rawOrders.map((o: any) => ({
		...
		pickupKm: '',
		pickupCoords: (o.pickup_x != null && o.pickup_y != null) ? { x: o.pickup_x, y: o.pickup_y, z: o.pickup_z ?? 0 } : null,
		...
		dropoffCoords: (o.dropoff_x != null && o.dropoff_y != null) ? { x: o.dropoff_x, y: o.dropoff_y, z: o.dropoff_z ?? 0 } : null,
		comment: o.comment ?? '',
		tag: o.tag ?? '',
